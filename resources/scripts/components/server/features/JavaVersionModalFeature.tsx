...
const JavaVersionModalFeature = () => {
    ...
    return (
        ...
        >
            ...
            <h2 css={tw`text-2xl mb-4 text-neutral-100`}>Version de Java non prise en charge</h2>
            <p css={tw`mt-4`}>
                Ce serveur utilise actuellement une version de Java non prise en charge et ne peut pas démarrer.
                <Can action={'startup.docker-image'}>
                    &nbsp;Sélectionnez une version prise en charge dans la liste ci-dessous pour poursuivre le démarrage du serveur.
                </Can>
            </p>
            <Can action={'startup.docker-image'}>
                <div css={tw`mt-4`}>
