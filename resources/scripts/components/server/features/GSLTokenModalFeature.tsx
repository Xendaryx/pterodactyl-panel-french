    ...
    return (
        <Formik onSubmit={updateGSLToken} initialValues={{ gslToken: '' }}>
            ...
            >
                ...
                <Form>
                    <h2 css={tw`text-2xl mb-4 text-neutral-100`}>Jeton GSL invalide !</h2>
                    <p css={tw`mt-4`}>
                        Votre jeton de connexion au serveur de jeu (jeton GSL) semble invalide ou expiré.
                    </p>
                    <p css={tw`mt-4`}>
                        Vous pouvez en générer un nouveau et le saisir ci-dessous, ou laisser le champ vide pour le
                    ...
                    <div css={tw`sm:flex items-center mt-4`}>
                        <Field
                            name={'gslToken'}
                            label={'Jeton GSL'}
                            description={'Consultez https://steamcommunity.com/dev/managegameservers pour générer un jeton.'}
                            autoFocus
                        />
                    </div>
                    <div css={tw`mt-8 sm:flex items-center justify-end`}>
                        <Button type={'submit'} css={tw`mt-4 sm:mt-0 sm:ml-4 w-full sm:w-auto`}>
                            Mettre à jour le jeton GSL
                        </Button>
                    </div>
                </Form>
            </Modal>
