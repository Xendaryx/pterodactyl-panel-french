...
const HytaleOauthRequireFeature = () => {
    ...
    return (
        ...
        >
            ...
            <h2 css={tw`text-2xl mb-4 text-neutral-100`}>Authentification requise</h2>
            <p css={tw`text-neutral-200`}>
                Vous devez vous authentifier avec votre compte Hytale pour télécharger ou mettre à jour les fichiers
                du serveur. Connectez-vous pour continuer.
            </p>
