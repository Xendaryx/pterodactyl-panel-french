            ...
            {(isNodeUnderMaintenance || isInstalling || isTransferring) && (
                <Alert type={'warning'} className={'mb-4'}>
                    {isNodeUnderMaintenance
                        ...
                        : isInstalling
                        ? 'Ce serveur est actuellement en cours d’installation et la plupart des actions sont indisponibles.'
                        : 'Ce serveur est actuellement en cours de transfert vers un autre nœud et toutes les actions sont indisponibles.'}
                </Alert>
            )}
