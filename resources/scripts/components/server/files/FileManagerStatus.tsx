    ...
    return (
        <div className={'space-y-2 mt-6'}>
            ...
            <Dialog.Footer>
                ...
                <Button.Text onClick={close}>Fermer</Button.Text>
            </Dialog.Footer>
        </div>
    );
};
...
const FileUploadListDialog = asDialog({
    title: 'Téléversements de fichiers',
    description: 'Les fichiers suivants sont en cours de téléversement vers votre serveur.',
})(FileUploadList);
