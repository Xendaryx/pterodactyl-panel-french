            ...
            {hash.replace(/^#/, '').endsWith('.pteroignore') && (
                <div css={tw`mb-4 p-4 border-l-4 bg-neutral-900 rounded border-cyan-400`}>
                    <p css={tw`text-neutral-300 text-sm`}>
                        Vous modifiez un fichier <code css={tw`font-mono bg-black rounded py-px px-1`}>.pteroignore</code>{' '}.
                        Tous les fichiers ou dossiers indiqués ici seront exclus des sauvegardes. Les caractères génériques
                        sont pris en charge avec un astérisque (<code css={tw`font-mono bg-black rounded py-px px-1`}>*</code>).
                        Vous pouvez annuler une règle précédente en la faisant précéder d’un point d’exclamation (
