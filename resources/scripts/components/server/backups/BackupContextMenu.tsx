...
export default ({ backup }: Props) => {
    ...
    return (
        <>
            ...
            >
                <p>
                    Votre serveur sera arrêté. Vous ne pourrez pas contrôler son état, accéder au gestionnaire de fichiers
                    ni créer de sauvegardes supplémentaires tant que la restauration ne sera pas terminée.
                </p>
            ...
            >
                Cette opération est définitive. La sauvegarde ne pourra pas être récupérée après sa suppression.
            </Dialog.Confirm>
