    ...
    return (
        <Formik
            ...
            validationSchema={object().shape({
                term: string().min(3, 'Saisissez au moins trois caractères pour lancer la recherche.'),
            })}
                ...
                <Modal {...props}>
                    <Form>
                        <FormikFieldWrapper
                            ...
                            description={'Saisissez un nom de serveur, un UUID ou une allocation pour lancer la recherche.'}
                        >
                            <SearchWatcher />
