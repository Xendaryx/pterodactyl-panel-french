                    ...
                    <form action="{{ route('admin.servers') }}" method="GET">
                        <div class="input-group input-group-sm">
                            ...
                            <div class="input-group-btn">
                                ...
                                <a href="{{ route('admin.servers.new') }}"><button type="button" class="btn btn-sm btn-primary" style="border-radius: 0 3px 3px 0;margin-left:-1px;">Créer un serveur</button></a>
                            </div>
                        </div>
                    </form>
                </div>
