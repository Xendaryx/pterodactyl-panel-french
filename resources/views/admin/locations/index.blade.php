...
@section('content-header')
    <h1>Emplacements<small>Tous les emplacements auxquels les nœuds peuvent être associés pour faciliter leur organisation.</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#newLocationModal">Créer un emplacement</button>
                </div>
            </div>
        ...
        <div class="modal-content">
            <form action="{{ route('admin.locations') }}" method="POST">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Créer un emplacement</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="text-muted small">Une description plus détaillée de cet emplacement. Elle doit contenir moins de 191 caractères.</p>
                        </div>
                    </div>
                </div>
