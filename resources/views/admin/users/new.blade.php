        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="name_last" class="control-label">Nom du client</label>
                        <div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        <p>Définir un mot de passe est facultatif. Les nouveaux utilisateurs sont invités par e-mail à créer leur mot de passe lors de leur première connexion. Si vous définissez un mot de passe ici, vous devrez le communiquer à l’utilisateur par un autre moyen.</p>
                    </div>
