...
@section('content-header')
    <h1>{{ $node->name }}<small>Gérez les allocations disponibles pour les serveurs de ce nœud.</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{ route('admin.nodes.view.allocation', $node->id) }}">Allocations</a></li>
    ...
    <div class="col-sm-8">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Allocations existantes</h3>
            </div>
    ...
    <div class="col-sm-4">
        <form action="{{ route('admin.nodes.view.allocation', $node->id) }}" method="POST">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Ajouter de nouvelles allocations</h3>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">Saisissez ici l’adresse IP à laquelle attribuer des ports.</p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">Si vous souhaitez attribuer un alias par défaut à ces allocations, saisissez-le ici.</p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">Saisissez ici des ports individuels ou des plages de ports, séparés par des virgules ou des espaces.</p>
                        </div>
                    </div>
                </div>
                <div class="box-footer">
                    {!! csrf_field() !!}
                    <button type="submit" class="btn btn-success btn-sm pull-right">Ajouter</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Supprimer les allocations d’un bloc IP</h4>
            </div>
...
@section('footer-scripts')
    ...
    $('button[data-action="deallocate"]').click(function (event) {
        ...
        swal({
            title: '',
            text: 'Voulez-vous vraiment supprimer cette allocation ?',
            type: 'warning',
    ...
    function deleteSelected() {
        ...
        if (selectedItems.length !== 0) {
            ...
            swal({
                type: 'warning',
                title: '',
                text: 'Voulez-vous vraiment supprimer les allocations suivantes : ' + formattedItems + '?',
                html: true,
                showCancelButton: true,
                ...
                $.ajax({
                    ...
                    swal({
                        ...
                        title: 'Erreur !',
                        html: true,
                        text: 'Une erreur est survenue lors de la suppression de ces allocations. Veuillez réessayer.',
                    });
                });
            });
        } else {
