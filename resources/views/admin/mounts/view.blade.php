...
@section('title')
    Montages &rarr; Détails &rarr; {{ $mount->id }}
@endsection
        ...
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addEggsModal">Ajouter des Eggs</button>
                    </div>
                </div>
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Nœuds</h3>

                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addNodesModal">Ajouter des Nœuds</button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts.eggs', $mount->id) }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Ajouter des Eggs</h4>
                    </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts.nodes', $mount->id) }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Ajouter des Nœuds</h4>
                    </div>

                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="pNodes">Nœuds</label>
...
@section('footer-scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#pEggs').select2({
                placeholder: 'Sélectionner des Eggs...',
            });

            $('#pNodes').select2({
                placeholder: 'Sélectionner des Nœuds...',
            });
            ...
            $('button[data-action="detach-node"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    element.parent().parent().addClass('warning').delay(100).fadeOut();
                    swal({ type: 'success', title: 'Nœud détaché.' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: 'Erreur !',
