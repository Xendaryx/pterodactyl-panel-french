    ...
    public function passes($attribute, $value): bool
    {
        if (filter_var($value, FILTER_VALIDATE_IP)) {
            ...
            if ($this->schemeField && Arr::get($this->data, $this->schemeField) === 'https') {
                $this->message = 'Le champ :attribute ne doit pas être une adresse IP lorsque HTTPS est activé.';
        ...
        $this->message = 'Le champ :attribute n’a pas pu être résolu vers une adresse IP valide.';
