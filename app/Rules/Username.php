...
class Username implements Rule
{
    ...
    {
        return 'Le champ :attribute doit commencer et se terminer par un caractère alphanumérique et ne contenir que des lettres, des chiffres, des tirets, des underscores et des points.';
    }
