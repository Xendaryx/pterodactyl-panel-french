...
class StartupController extends ClientApiController
{
    ...
    public function update(UpdateStartupVariableRequest $request, Server $server): array
    {
        ...
        if (is_null($variable) || !$variable->user_viewable) {
            throw new BadRequestHttpException('La variable d’environnement que vous essayez de modifier n’existe pas.');
        } elseif (!$variable->user_editable) {
            throw new BadRequestHttpException('La variable d’environnement que vous essayez de modifier est en lecture seule.');
        }
