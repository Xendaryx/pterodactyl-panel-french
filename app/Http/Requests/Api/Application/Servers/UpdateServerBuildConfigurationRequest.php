...
class UpdateServerBuildConfigurationRequest extends ServerWriteRequest
{
    ...
    {
        return [
            'add_allocations' => 'allocations à ajouter',
            'remove_allocations' => 'allocations à retirer',
            'add_allocations.*' => 'allocation à ajouter',
            'remove_allocations.*' => 'allocation à retirer',
            'feature_limits.databases' => 'Limite de bases de données',
            'feature_limits.allocations' => 'Limite d’allocations',
            'feature_limits.backups' => 'Limite de sauvegardes',
        ];
    }
