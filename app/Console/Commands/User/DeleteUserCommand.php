...
{
    protected $description = 'Supprime un utilisateur du Panel si aucun serveur n’est associé à son compte.';
    ...
    public function handle(): int
    {
        ...
        Assert::notEmpty($search, 'Le terme de recherche doit être une adresse e-mail, valeur reçue : %s.');
        ...
        if ($this->input->isInteractive()) {
            ...
            $this->table(['ID utilisateur', 'E-mail', 'Nom'], $tableValues);
