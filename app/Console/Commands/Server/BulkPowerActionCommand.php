...
class BulkPowerActionCommand extends Command
{
    protected $signature = 'p:server:bulk-power
                            {action : L’action à effectuer (start, stop, restart, kill)}
                            {--servers= : Une liste de serveurs séparés par des virgules.}
                            {--nodes= : Une liste de nœuds séparés par des virgules.}';

    protected $description = 'Effectue une gestion groupée de l’alimentation sur plusieurs serveurs ou nœuds à la fois.';
