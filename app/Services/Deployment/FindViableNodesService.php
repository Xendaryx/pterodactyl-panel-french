...
class FindViableNodesService
{
    ...
    {
        Assert::allIntegerish($locations, 'Un tableau d’identifiants de localisation doit être fourni lors de l’appel à setLocations.');
    ...
    {
        Assert::integer($this->disk, 'L’espace disque doit être un entier, valeur reçue : %s');
        Assert::integer($this->memory, 'L’utilisation de la mémoire doit être un entier, valeur reçue : %s');
