...
class BackupManager
{
    ...
    protected function resolve(string $name): FilesystemAdapter
    {
        ...
        if (empty($config['adapter'])) {
            throw new \InvalidArgumentException("Le disque de sauvegarde [$name] ne possède aucun adaptateur configuré.");
        }
        ...
        throw new \InvalidArgumentException("L’adaptateur [$adapter] n’est pas pris en charge.");
    }
